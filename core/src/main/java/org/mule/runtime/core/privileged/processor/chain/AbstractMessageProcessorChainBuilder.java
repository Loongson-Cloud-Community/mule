...
public abstract class AbstractMessageProcessorChainBuilder implements MessageProcessorChainBuilder {
  ...
  protected ComponentSpanInfo chainComponentSpanInfo;
  ...
  @Override
  public void setChainComponentSpanInfo(ComponentSpanInfo chainComponentSpanInfo) {
    this.chainComponentSpanInfo = chainComponentSpanInfo;
  }
}
